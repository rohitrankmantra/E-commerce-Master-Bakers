      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            {/* <div className="absolute -bottom-6 -right-6 w-48 h-48 rounded-2xl overflow-hidden hidden md:block shadow-xl">
             <p></p>
            </div> */}
          </motion.div>
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-5xl text-primary mt-3 mb-6">
              Why Choose Us
            </h2>
